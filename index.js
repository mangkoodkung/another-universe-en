    ...
    <div id="au-mobile-card-overlay" style="${getOverlayStyle()}">
        <div class="au-universal-popup">
            ...
            <div class="au-universal-popup-body">
                ${bodyHtml}
                <div style="text-align:center;padding-top:16px;font-size:0.8em;opacity:0.5;border-top:1px dashed rgba(255,255,255,0.15);margin-top:20px;">Powered by <b>POPKO</b></div>
            </div>
            <div class="au-universal-popup-footer" style="display:flex; flex-direction:row; justify-content:center; gap:8px; padding:12px; border-top:1px solid rgba(255, 255, 255, 0.1);">
    ...
    <div id="au-welcome-overlay" style="${getOverlayStyle()}">
        <div class="au-universal-popup">
            ...
            <div class="au-universal-popup-body" style="padding: 24px; text-align: left;">
                <h3 style="margin-top:0; margin-bottom:16px; color:#ffffff;">
                ...
                <div style="margin-top: 28px; font-size: 0.65em; opacity: 0.6; text-align:center; padding-top: 14px; border-top: 1px dashed rgba(255, 255, 255, 0.15);">
